...
CREATE TABLE `user_roles` (
  ...
  KEY `user_id` (`user_id`),
  KEY `role_id` (`role_id`),
  CONSTRAINT `user_roles_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `usuario` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `user_roles` VALUES (1,2,1),(2,3,1),(3,4,1),(4,5,1);
