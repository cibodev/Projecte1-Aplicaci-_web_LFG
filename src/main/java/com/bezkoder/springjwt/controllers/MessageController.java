...
import com.bezkoder.springjwt.security.services.MessageServiceImpl;
...
public class MessageController {
	...
	public Message actualizarMessage(@PathVariable(name = "id") int id, @RequestBody Message Message) {
		...
		Message_seleccionado.setId_usuario(Message.getId_usuario());
		Message_seleccionado.setMessage(Message.getMessage());
		Message_seleccionado.setFecha(Message.getFecha());
